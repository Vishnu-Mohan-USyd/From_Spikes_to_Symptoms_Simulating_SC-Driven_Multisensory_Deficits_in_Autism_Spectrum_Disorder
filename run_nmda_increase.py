...
The SBW cache suffix follows the canonical files generated by
...
def run_sbw_nmda_increase():
    ...
    cache_path = CACHE_DIR / "sbw_nmda_increase_t1110.npz"
    ...
    ctrl_cache = np.load(CACHE_DIR / "sbw_control_t1110.npz")
